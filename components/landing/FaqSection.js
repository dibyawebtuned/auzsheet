...
const FaqSection = () => {
    return (
        <div className="auz_bg">
            <div className="max-w-360 mx-auto px-3 md:px-5 lg:px-5 xl:px-25 py-[80px] flex gap-[50px]">
                <div className="flex-1">
                    {/* Section Heading */}
                    <div className='flex flex-col items-start gap-[15px] mb-10'>
                        <div className=''>
                            <h2 className='host-grotesk text-[43px] host-grotesk-semibold'>Frequently Asked Questions</h2>
                        </div>
                        <div className=''>
