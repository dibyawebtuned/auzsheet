              ...
              <div className='flex-8 flex flex-col gap-5 sm:gap-7'>
                ...
                <div className='flex flex-col gap-[30px]'>
                  <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                    Auzsheet supplies and installs high-quality metal and PVC downpipes,
                    offering durable, reliable drainage solutions designed to suit your
                    roof, gutter profile, and local conditions.

                    <br />

                    We work with a variety of materials and sizes, ensuring every installation
                    meets both functional and aesthetic requirements. Whether for new builds
                    or upgrades, our team delivers expert workmanship to ensure long-lasting
                  ...
                  <div className='bg-white rounded-[20px] px-4 sm:px-7 py-5 flex flex-col gap-4 sm:gap-5'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                      <div className='flex-1 flex items-center gap-2 sm:gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          High-quality metal and PVC downpipes for every project
                        </span>
                      </div>
                      <div className='flex-1 flex items-center gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Solutions customised to suit your roof and gutter system
                        </span>
                      </div>
                    </div>
                    {/*  */}
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                      <div className='flex-1 flex items-center gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Expert installation for reliable, long-lasting performance
                        </span>
                      </div>
                      <div className='flex-1 flex items-center gap-3'>
                        <div className='p-2 rounded-[5px] bg-[#303030]'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Low-maintenance options designed for Australian conditions
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                      To further enhance your property’s drainage system, we also offer customised
                      solutions including rainwater collection systems and seamless integration
                      with gutters and fascia. This ensures optimal water flow, reduces the
                      risk of leaks or blockages, and adds a polished, professional finish to
                      ...
                      <div className='flex flex-col gap-4 sm:gap-3 flex-1'>
                        ...
                        <div className='flex flex-col gap-1 sm:gap-2'>
                          ...
                          <p className='host-grotesk host-grotesk-semibold auz_text_gray text-sm sm:text-base leading-6'>
                            Committed to delivering reliable, high-quality drainage solutions with precision and care.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex flex-col gap-4 sm:gap-3 flex-1'>
                        ...
                        <div className='flex flex-col gap-1 sm:gap-2'>
                          ...
                          <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6 text-sm sm:text-base'>
                            To be the trusted choice for homeowners seeking durable, efficient, and visually appealing downpipe systems.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="flex-1 lg:flex-4 flex flex-col gap-[20px] lg:sticky lg:top-[100px] self-start h-fit">
                ...
                <div className="bg-white rounded-[20px] p-4 sm:p-6" data-aos="fade-up">
                  ...
                  <div className="flex flex-col gap-4 sm:gap-5">
                    ...
                    {/* Service item */}
                    <Link href="/services/skylight" className="flex items-center gap-3 sm:gap-5 pb-3 sm:pb-4 border-b border-gray-400">
                      <div>
                        <h4 className="host-grotesk host-grotesk-semibold text-[17px] sm:text-[18px]">
...
export default DownpipeComponent
