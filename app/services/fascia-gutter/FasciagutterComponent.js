                            ...
                            <div className='flex-8 flex flex-col gap-5 sm:gap-7'>
                                ...
                                <div className='flex flex-col gap-[30px]'>
                                    <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                                        Auzsheet supplies and installs high-quality Colorbond® fascia covers, designed to protect existing timber fascias from weather damage while providing a durable, low-maintenance, and modern finish. Our solutions enhance the look of your home while extending the life of your existing roofline.

                                        <br />

                                        We also provide expert gutter installation and upgrades, ensuring efficient water flow and reliable protection against leaks and blockages. With a wide range of profiles and colours, our fascia and gutter systems are tailored to complement any roof style and architectural design, combining functionality with aesthetic appeal.
                                    </p>
                                    ...
                                    <div className='bg-white rounded-[20px] px-4 sm:px-7 py-5 flex flex-col gap-4 sm:gap-5'>
                                        ...
                                        <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                                            <div className='flex-1 flex items-center gap-2 sm:gap-3'>
                                                ...
                                                <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                                                    Premium Colorbond fascia covers for long-lasting protection
                                                </span>
                                            </div>
                                            <div className='flex-1 flex items-center gap-3'>
                                                ...
                                                <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                                                    Low-maintenance solutions to enhance your home’s exterior
                                                </span>
                                            </div>
                                        </div>
                                        {/*  */}
                                        <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                                            <div className='flex-1 flex items-center gap-3'>
                                                ...
                                                <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                                                    Expert gutter installation and upgrades for reliable drainage
                                                </span>
                                            </div>
                                            <div className='flex-1 flex items-center gap-3'>
                                                <div className='p-2 rounded-[5px] bg-[#303030]'>
                                                ...
                                                <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                                                    Customised profiles and colours to suit any roof design
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className='flex flex-col gap-4 sm:gap-3 flex-1'>
                                                ...
                                                <div className='flex flex-col gap-1 sm:gap-2'>
                                                    ...
                                                    <p className='host-grotesk host-grotesk-semibold auz_text_gray text-sm sm:text-base leading-6'>
                                                        To deliver high-quality, durable, and stylish fascia and gutter solutions that protect and enhance every home.
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div className='flex flex-col gap-4 sm:gap-3 flex-1'>
                                                ...
                                                <div className='flex flex-col gap-1 sm:gap-2'>
                                                    ...
                                                    <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6 text-sm sm:text-base'>
                                                        To be the trusted choice for homeowners seeking modern, low-maintenance, and reliable roofline solutions.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
export default FasciagutterComponent
