              ...
              <div className='flex-8 flex flex-col gap-5 sm:gap-7'>
                ...
                <div className='flex flex-col gap-[30px]'>
                  <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                    Auzsheet specialises in tile-to-Colorbond® re-roofs, transforming existing roofs into lighter, more durable, and modern designs. We supply and install premium Colorbond® roofing from all major brands, providing improved drainage, enhanced weather resistance, and a sleek, updated appearance.

                    <br />

                    Our experienced team manages every step of the re-roofing process with precision and care, ensuring minimal disruption while delivering a high-quality finish. Whether upgrading for aesthetics, performance, or both, our re-roofing solutions give your home a fresh, contemporary look while maintaining long-lasting protection a
                  </p>
                  ...
                  <div className='bg-white rounded-[20px] px-4 sm:px-7 py-5 flex flex-col gap-4 sm:gap-5'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                      <div className='flex-1 flex items-center gap-2 sm:gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Tile-to-Colorbond re-roofs for lighter, stronger roofs
                        </span>
                      </div>
                      <div className='flex-1 flex items-center gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Premium Colorbond materials from all major brands
                        </span>
                      </div>
                    </div>
                    {/*  */}
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                      <div className='flex-1 flex items-center gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Improved drainage and weather protection
                        </span>
                      </div>
                      <div className='flex-1 flex items-center gap-3'>
                        <div className='p-2 rounded-[5px] bg-[#303030]'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Expert installation for a modern, polished finish
                        </span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className='flex flex-col gap-4 sm:gap-3 flex-1'>
                        ...
                        <div className='flex flex-col gap-1 sm:gap-2'>
                          ...
                          <p className='host-grotesk host-grotesk-semibold auz_text_gray text-sm sm:text-base leading-6'>
                            To deliver durable, stylish, and reliable re-roofing solutions that enhance the safety and appearance of every home.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className='flex flex-col gap-4 sm:gap-3 flex-1'>
                        ...
                        <div className='flex flex-col gap-1 sm:gap-2'>
                          ...
                          <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6 text-sm sm:text-base'>
                            To be the trusted choice for homeowners seeking high-quality, modern re-roofing solutions that stand the test of time.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default ReroofComponent
