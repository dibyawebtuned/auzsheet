...
const InsulatedpanelingComponent = () => {
  return (
    <>
              ...
              <div className='flex-8 flex flex-col gap-5 sm:gap-7'>
                ...
                <div className='flex flex-col gap-[30px]'>
                  <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                    Auzsheet supplies and installs premium Colorbond® roofing for new builds,
                    working with all major brands and offering a variety of profiles and colours
                    to suit any project.

                    <br />

                    Our team works with all major Colorbond® profiles and colour ranges, allowing
                    you to customise your roof to suit both contemporary and traditional homes.
                    From clean architectural lines to timeless finishes, we ensure every installation
                    enhances curb appeal while providing reliable protection against harsh
                  ...
                  <div className='bg-white rounded-[20px] px-4 sm:px-7 py-5 flex flex-col gap-4 sm:gap-5'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                      <div className='flex-1 flex items-center gap-2 sm:gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Premium Colorbond® steel roofing for long-lasting durability
                        </span>
                      </div>
                      <div className='flex-1 flex items-center gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Wide range of profiles and colours to suit every home
                        </span>
                      </div>
                    </div>
                    {/*  */}
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-5'>
                      <div className='flex-1 flex items-center gap-3'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Expert fascia and gutter installations & upgrades
                        </span>
                      </div>
                      <div className='flex-1 flex items-center gap-3'>
                        <div className='p-2 rounded-[5px] bg-[#303030]'>
                        ...
                        <span className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                          Skylight installations to bring natural light into your home
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <p className='host-grotesk host-grotesk-semibold auz_text_gray leading-6'>
                      For homeowners looking to elevate their property further, we also offer
                      skylight installations, designed to flood interior spaces with natural
                      light and improve overall comfort. In addition, our Colorbond® Architectural
                      Wall Cladding solutions provide a bold, modern finish that transforms
                      exteriors while delivering long-lasting durability and low maintenance.
...
export default InsulatedpanelingComponent