            ...
            <div className='max-w-360 mx-auto md:mx-5 lg:mx-5 xl:mx-25 mt-[100px] flex justify-center  relative rounded-[30px] overflow-hidden'>
                <div className='px-4 md:px-8 py-10 md:py-16 flex flex-col gap-[15px] sm:gap-[30px] auz_bg'>
                    ...
                    <div className="relative w-full">
                        ...
                        <div className="absolute top-[20px] sm:top-[60px] lg:top-[60px] border border-white left-1/2 sm:left-3/4 transform -translate-x-1/2 bg-black text-white w-[90%] sm:w-[70%] lg:w-[40%] max-w-[800px] rounded-[12px] px-4 sm:px-5 py-4 sm:py-6 flex flex-row gap-4">
